...
export const portals = [
  ...
  portal({ id: "sigortabin", name: "SigortaBin", url: "https://www.sigortabin.com.tr/urunler/trafik-sigortasi", adapter: "generic", group: "Karşılaştırma sitesi", verifiedForm: true, defaultEnabled: false, deactivated: true, otpTrigger: "after_phone_submit", smsPolicy: "per_query", fresh: true, checkAllBoxes: true, smsEvidence: "Kullanıcı gözlemi: TC/telefon girildikten sonra SMS ile doğrulama isteniyor" }),
  ...
  portal({ id: "sigorta7", name: "Sigorta7", url: "https://www.sigorta7.com/trafik-sigortasi", adapter: "generic", group: "Karşılaştırma sitesi", verifiedForm: true, defaultEnabled: false, deactivated: true }),
  ...
  portal({ id: "sigortala", name: "Sigorta.la", url: "https://sigorta.la/oto/trafik-sigortasi-satin-al", adapter: "generic", group: "Karşılaştırma sitesi", verifiedForm: true, smsPolicy: "per_query", checkAllBoxes: true, resultTimeoutMs: 180000 }),
  ...
  portal({ id: "policekes", name: "PoliçeKes", url: "https://www.policekes.com/oto/trafik-sigortasi-satin-al", adapter: "generic", group: "Karşılaştırma sitesi", verifiedForm: true, smsPolicy: "per_query", checkAllBoxes: true, resultTimeoutMs: 180000 }),
