...
export const portals = [
  ...
  portal({ id: "sigortabaz", name: "SigortaBaz", url: "https://teklif.sigortabaz.com/trafik", adapter: "ihsan", group: "İhsan altyapısı", verifiedForm: true, defaultEnabled: true, integrationStatus: "beta" }),
  portal({ id: "sigortamobil", name: "SigortaMobil", url: "https://sigortamobil.sigorta.online/trafik", adapter: "ihsan", group: "İhsan altyapısı", verifiedForm: true }),
  portal({ id: "tasalti", name: "Taşaltı Teklif", url: "https://tasalti.sigorta.online/trafik", adapter: "ihsan", group: "İhsan altyapısı", verifiedForm: true }),
  portal({ id: "sert", name: "Sert Sigorta", url: "https://sert.sigorta.online/trafik", adapter: "ihsan", group: "İhsan altyapısı", verifiedForm: false }),
  portal({ id: "nepratik", name: "Ne Pratik Sigorta", url: "https://nepratiksigorta.com/Trafik", adapter: "ihsan", group: "İhsan altyapısı", verifiedForm: false }),
  portal({ id: "iskenderun", name: "İskenderun Teklif", url: "https://iskenderun.sigorta.online/trafik", adapter: "ihsan", group: "İhsan altyapısı", verifiedForm: false }),
  portal({ id: "sigortammilli", name: "Sigortam Milli", url: "https://sigortammilli.com.tr/trafik-sigortasi/", adapter: "ihsan-frame", group: "İhsan altyapısı", verifiedForm: true }),
  ...
  portal({ id: "sigortala", name: "Sigorta.la", url: "https://sigorta.la/page/trafik-sigortasi", adapter: "generic", group: "Karşılaştırma sitesi", verifiedForm: true }),
  portal({ id: "dijipol", name: "Dijipol", url: "https://www.dijipol.com/", adapter: "generic", group: "Karşılaştırma sitesi", verifiedForm: true }),
  portal({ id: "hangikredi", name: "HangiKredi Sigorta", url: "https://www.hangikredi.com/sigorta/zorunlu-trafik-sigortasi", adapter: "generic", group: "Banka / platform", verifiedForm: true }),
  portal({ id: "enpara", name: "Enpara Sigorta", url: "https://www.enpara.com/sigortalar/trafik-sigortasi", adapter: "generic", group: "Banka / platform", verifiedForm: true }),
  portal({ id: "hepiyi", name: "Hepiyi", url: "https://hepiyi.com.tr/trafik-sigortasi/form/arac-bilgileri", adapter: "generic", group: "Sigorta şirketi", verifiedForm: true }),
  portal({ id: "quick", name: "Quick Sigorta", url: "https://www.quicksigorta.com/zorunlu-trafik-sigortasi", adapter: "generic", group: "Sigorta şirketi", verifiedForm: true }),
  ...
  portal({ id: "policekes", name: "PoliçeKes", url: "https://www.policekes.com/", adapter: "generic", group: "Karşılaştırma sitesi", verifiedForm: true }),
];
