...
export const portals = [
  ...
  portal({ id: "sigortabaz", name: "SigortaBaz", url: "https://teklif.sigortabaz.com/trafik", adapter: "ihsan", group: "İhsan altyapısı", verifiedForm: true, defaultEnabled: false, integrationStatus: "beta", navigationTimeoutMs: 60000 }),
  ...
  portal({ id: "iskenderun", name: "İskenderun Teklif", url: "https://iskenderun.sigorta.online/trafik", adapter: "ihsan", group: "İhsan altyapısı", verifiedForm: true, defaultEnabled: true, integrationStatus: "beta", smsPolicy: "session_once", smsEvidence: "Kullanıcı gözlemi: oturum açılırken bir kez SMS istiyor; açık oturum sonraki sorgularda kullanılabiliyor"  }),
  portal({ id: "sigortammilli", name: "Sigortam Milli", url: "https://sigortammilli.com.tr/trafik-sigortasi/", adapter: "ihsan", group: "İhsan altyapısı", verifiedForm: true, defaultEnabled: true, integrationStatus: "beta", smsPolicy: "session_once", smsEvidence: "Kullanıcı gözlemi: oturum açılırken bir kez SMS istiyor; açık oturum sonraki sorgularda kullanılabiliyor" }),
  //portal({ id: "sigortam", name: "Sigortam.net", url: "https://www.sigortam.net/trafik-sigortasi", adapter: "generic", group: "Karşılaştırma sitesi", verifiedForm: true, defaultEnabled: true }),
  ...
  portal({ id: "enuygun", name: "Enuygun Sigorta", url: "https://www.enuygunsigorta.com/zorunlu-trafik-sigortasi/", adapter: "generic", group: "Karşılaştırma sitesi", verifiedForm: true, defaultEnabled: true, otpTrigger: "after_phone_submit", smsPolicy: "per_query", smsEvidence: "Resmî trafik teklif formu: cep telefonu numarasına birazdan SMS ile doğrulama kodu iletileceğini açıkça belirtiyor" }),
  ...
  //portal({ id: "sompo", name: "Sompo Sigorta", url: "https://www.somposigorta.com.tr/trafik-sigortasi", adapter: "generic", group: "Sigorta şirketi", verifiedForm: true, defaultEnabled: true }),
