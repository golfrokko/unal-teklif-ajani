...
export const portals = [
  ...
  portal({ id: "sigortakurdu", name: "sigortakurdu", url: "https://www.sigortakurdu.com.tr/offer-step/trafik-sigortasi", adapter: "generic", group: "Karşılaştırma sitesi", verifiedForm: true, fieldOrder: ["plate", "registration", "identity", "nameEmail", "phone", "birthDate"] }),
  ...
  portal({ id: "ibksigorta", name: "ibksigorta", url: "https://www.ibksigorta.com.tr/trafik-sigortasi-teklif-al.html", adapter: "generic", group: "Karşılaştırma sitesi", verifiedForm: true, imageCaptcha: true }),
  portal({ id: "emaxsigorta", name: "emaxsigorta", url: "https://www.emaxsigorta.com.tr/teklif-al/trafik", adapter: "generic", group: "Karşılaştırma sitesi", verifiedForm: true, imageCaptcha: true }),
  ...
  portal({ id: "sigortala", name: "Sigorta.la", url: "https://sigorta.la/oto/trafik-sigortasi-satin-al?yenileme=0", adapter: "generic", group: "Karşılaştırma sitesi", verifiedForm: true }),
  ...
  portal({ id: "policekes", name: "PoliçeKes", url: "https://www.policekes.com/oto/trafik-sigortasi-satin-al?yenileme=0", adapter: "generic", group: "Karşılaştırma sitesi", verifiedForm: true }),
