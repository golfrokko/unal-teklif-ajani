...
export const portals = [
  ...
  portal({ id: "sigortamobil", name: "SigortaMobil", url: "https://sigortamobil.sigorta.online/trafik", adapter: "ihsan", group: "İhsan altyapısı", verifiedForm: true, defaultEnabled: true, integrationStatus: "beta", smsPolicy: "session_once", smsEvidence: "Kullanıcı gözlemi: oturum açılırken bir kez SMS istiyor; açık oturum sonraki sorgularda kullanılabiliyor" }),
  portal({ id: "tasalti", name: "Taşaltı Teklif", url: "https://tasalti.sigorta.online/trafik", adapter: "ihsan", group: "İhsan altyapısı", verifiedForm: true, defaultEnabled: true, integrationStatus: "beta", smsPolicy: "session_once", smsEvidence: "Kullanıcı gözlemi: oturum açılırken bir kez SMS istiyor; açık oturum sonraki sorgularda kullanılabiliyor" }),
  portal({ id: "sert", name: "Sert Sigorta", url: "https://sert.sigorta.online/trafik", adapter: "ihsan", group: "İhsan altyapısı", verifiedForm: true, defaultEnabled: true, integrationStatus: "beta", smsPolicy: "session_once", smsEvidence: "Kullanıcı gözlemi: oturum açılırken bir kez SMS istiyor; açık oturum sonraki sorgularda kullanılabiliyor" }),
  portal({ id: "nepratik", name: "Ne Pratik Sigorta", url: "https://nepratiksigorta.com/Trafik", adapter: "ihsan", group: "İhsan altyapısı", verifiedForm: true, defaultEnabled: true, integrationStatus: "beta", smsPolicy: "session_once", smsEvidence: "Kullanıcı gözlemi: oturum açılırken bir kez SMS istiyor; açık oturum sonraki sorgularda kullanılabiliyor"  }),
  ...
  portal({ id: "sigortabin", name: "SigortaBin", url: "https://www.sigortabin.com.tr/urunler/trafik-sigortasi", adapter: "generic", group: "Karşılaştırma sitesi", verifiedForm: true, defaultEnabled: false, forceDisabled: true, integrationStatus: "paused", otpTrigger: "after_phone_submit", smsPolicy: "per_query", fresh: true, checkAllBoxes: true, smsEvidence: "Kullanıcı gözlemi: TC/telefon girildikten sonra SMS ile doğrulama isteniyor" }),
  portal({ id: "sigortaladim", name: "Sigortaladım", url: "https://www.sigortaladim.com/zorunlu-trafik-sigortasi", adapter: "generic", group: "Karşılaştırma sitesi", verifiedForm: true, fieldOrder: ["identity", "nameEmail", "phone", "birthDate", "city", "district", "occupation"], defaultCity: "Karabük", defaultDistrict: "Merkez", defaultOccupation: "Diğer" }),
  ...
  portal({ id: "supersigortam", name: "supersigortam", url: "https://www.supersigortam.com/trafik-sigortasi-teklifi-al/", adapter: "generic", group: "Karşılaştırma sitesi", verifiedForm: true, fieldOrder: ["nameEmail", "phone", "identity", "birthDate", "plate", "registration"], checkAllBoxes: true, resultTimeoutMs: 150000 }),
  portal({ id: "bisigorta", name: "bisigorta", url: "https://www.bisigorta.com/trafik-sigortasi", adapter: "generic", group: "Karşılaştırma sitesi", verifiedForm: true }),
  portal({ id: "koalay", name: "Koalay", url: "https://www.koalay.com/zorunlu-trafik-sigortasi", adapter: "generic", group: "Karşılaştırma sitesi", verifiedForm: true, defaultEnabled: true, checkAllBoxes: true, registrationInputOrder: [1, 2] }),
  ...
  portal({ id: "sigortambir", name: "Sigortambir", url: "https://www.sigortambir.com/zorunlu-trafik-sigortasi", adapter: "generic", group: "Karşılaştırma sitesi", verifiedForm: true, defaultEnabled: true, fieldOrder: ["identity", "plate", "phone"], smsPolicy: "per_query", offerCollectionWindowMs: 60000, resultTimeoutMs: 120000 }),
  portal({ id: "sigorta7", name: "Sigorta7", url: "https://www.sigorta7.com/trafik-sigortasi", adapter: "generic", group: "Karşılaştırma sitesi", verifiedForm: true, defaultEnabled: false, forceDisabled: true, integrationStatus: "paused" }),
  ...
  portal({ id: "sigortala", name: "Sigorta.la", url: "https://sigorta.la/oto/trafik-sigortasi-satin-al", adapter: "generic", group: "Karşılaştırma sitesi", verifiedForm: true, defaultEnabled: true, integrationStatus: "beta", smsPolicy: "per_query", smsEvidence: "Kullanıcı tarafından doğrulanan akış: Teklif Al sonrasında SMS doğrulama penceresi açılıyor", fieldOrder: ["corporateMode", "identity", "birthDate", "phone", "nameEmail", "plate", "registration"] }),
  portal({ id: "dijipol", name: "Dijipol", url: "https://www.dijipol.com/zorunlu-trafik-sigortasi", adapter: "generic", group: "Karşılaştırma sitesi", verifiedForm: true, defaultEnabled: true }),
  portal({ id: "policekes", name: "PoliçeKes", url: "https://www.policekes.com/oto/trafik-sigortasi-satin-al", adapter: "generic", group: "Karşılaştırma sitesi", verifiedForm: true, defaultEnabled: true, integrationStatus: "beta", smsPolicy: "per_query", smsEvidence: "Kullanıcı tarafından doğrulanan akış: Teklif Al sonrasında SMS doğrulama penceresi açılıyor", fieldOrder: ["corporateMode", "identity", "birthDate", "phone", "nameEmail", "plate", "registration"], offerCollectionWindowMs: 60000, resultTimeoutMs: 120000 }),
