...
export const portals = [
  ...
  portal({ id: "supersigortam", name: "supersigortam", url: "https://www.supersigortam.com/trafik-sigortasi-teklifi-al/", adapter: "generic", group: "Karşılaştırma sitesi", verifiedForm: true }),
